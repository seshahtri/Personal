...
FROM dbo.V_MatterBudgetDetails V_MatterBudgetDetails
  ...
  FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (^ParamOne^, ''|'',^ParamTwo^,1)
  --FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (''42406'', ''|'',''42318'',1)
