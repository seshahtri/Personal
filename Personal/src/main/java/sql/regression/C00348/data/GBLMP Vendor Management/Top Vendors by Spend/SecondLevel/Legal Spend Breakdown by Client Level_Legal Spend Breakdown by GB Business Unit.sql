...
--FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (-1, ''|'',43571,0)) p on pa.practiceareaid=p.rolluppracticeareaid
FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (-1, ''|'',^ParamTwo^,0)) p on pa.practiceareaid=p.rolluppracticeareaid
inner join (
