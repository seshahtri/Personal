...
--FROM [dbo].[fn_GetRollupBusinessUnitsWithSecurity] (-1, ''|'',16573,1)) ba on ba.RollupBusinessUnitId=b.BusinessUnitId
FROM [dbo].[fn_GetRollupBusinessUnitsWithSecurity] (-1, ''|'',^ParamOne^,1)) ba on ba.RollupBusinessUnitId=b.BusinessUnitId
