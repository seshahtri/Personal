...
EXECUTE AS USER=''admin''
	SELECT   
		...
		INNER JOIN (SELECT 1 PACheck, RollupPracticeAreaId, RollupPracticeAreaName, RollupPracticeAreaPath, RollupPracticeAreaDisplayPath, RollupPracticeAreaLevel    
					FROM fn_GetRollupPracticeAreasWithSecurity2 (''46997'', ''|'',-1,0)) pa ON pad.PracticeAreaId = pa.RollupPracticeAreaId   
					--FROM fn_GetRollupPracticeAreasWithSecurity2 (^ParamTwo^, ''|'',-1,0)) pa ON pad.PracticeAreaId = pa.RollupPracticeAreaId  
