...
SELECT top 1 RollupBusinessUnitsWithSecurity.RollupBusinessUnitId,
RollupBusinessUnitsWithSecurity.RollupBusinessUnitName AS [GB BusinessUnit Name], 
...
GROUP BY RollupBusinessUnitsWithSecurity.RollupBusinessUnitId,RollupBusinessUnitsWithSecurity.RollupBusinessUnitName
order by COUNT_BIG(DISTINCT MSS.MatterId) desc, [GB BusinessUnit Name] desc
'
print(@SQL)
exec(@SQL)