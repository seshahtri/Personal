...
SELECT top 1 RollupPracticeAreasWithSecurity.RollupPracticeAreaId as PracticeAreaId,
RollupPracticeAreasWithSecurity.RollupPracticeAreaName AS PracticeAreaName,  
...
GROUP BY  RollupPracticeAreasWithSecurity.RollupPracticeAreaId,[RollupPracticeAreasWithSecurity].[RollupPracticeAreaName]--, ExchangeRateDim.CurrencyCode
