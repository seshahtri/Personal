...
SELECT 
      Top 1 
      [V_MatterBudgetDetails].[PracticeAreaId],
	[RollupPracticeAreasWithSecurity].[RollupPracticeAreaName] AS [GB Client],  MAX([ExchangeRateDim1].[CurrencyCode]) AS [Currency Code],  
