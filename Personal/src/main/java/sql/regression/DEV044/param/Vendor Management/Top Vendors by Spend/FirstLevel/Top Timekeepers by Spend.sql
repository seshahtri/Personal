...
SET @SQL='
	...
	where
	(InvoiceDate >= ''' + @pDateStart + ''' AND InvoiceDate<= ''' + @pDateEnd + ''')
...
--AND Vendorid = ''53626''
	...
	Group by T.timekeeperid,timekeeperroleid,TimekeeperName ,VendorparentName,RoleName,e.currencycode 
	order by fee desc,timekeepername desc'
