...
SELECT top 1 tm.RollupBusinessUnitId,
...
FROM V_MatterSpendSummary m
       ...
       JOIN(
              SELECT bu.RollupBusinessUnitName, bu.RollupBusinessUnitId, COUNT(DISTINCT m.MatterId) TotalMatters
...
GROUP BY
       tm.RollupBusinessUnitName, tm.RollupBusinessUnitId,
          buu.CurrencyCode,
