...
[RollupPracticeAreasWithSecurity].[RollupPracticeAreaName] AS [Practice Area], MAX([ExchangeRateDim1].[CurrencyCode]) AS [Currency Code],
...
GROUP BY [RollupPracticeAreasWithSecurity].[RollupPracticeAreaId],
