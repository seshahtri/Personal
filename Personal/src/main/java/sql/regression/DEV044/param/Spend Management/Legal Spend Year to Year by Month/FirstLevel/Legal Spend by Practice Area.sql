...
exec as user=''admin''
select top 1 pa.RollupPracticeAreaId,
pa.RollupPracticeAreaName as [Practice Area ],ed.CurrencyCode as [Currency Code], Sum(invs.Amount*ISNULL(ed.ExchangeRate,1)) as [Total Spend]
