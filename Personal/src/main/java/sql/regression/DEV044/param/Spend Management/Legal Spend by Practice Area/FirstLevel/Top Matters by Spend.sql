...
SET @SQL = '
exec as user=''admin''
Select  top 1 f.matterId,
f.MatterName as ''Matter Name'', pa.RollupPracticeAreaName as ''Practice Area'', f.MatterStatus as ''Matter Status'', E.currencyCode as ''Currency Code'' ,
