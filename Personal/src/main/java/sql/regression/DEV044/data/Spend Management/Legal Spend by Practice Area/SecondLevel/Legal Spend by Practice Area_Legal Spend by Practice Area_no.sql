...
FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (''^ParamOne^'', ''|'',^ParamTwo^,1)) pa on pa.RollupPracticeAreaId=p.PracticeAreaId
--FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (''32475'', ''|'',32504,1)) pa on pa.RollupPracticeAreaId=p.PracticeAreaId
