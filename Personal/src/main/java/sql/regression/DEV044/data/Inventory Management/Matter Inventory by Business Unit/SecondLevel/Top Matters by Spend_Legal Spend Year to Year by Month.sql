...
from matterdim m
	...
	INNER JOIN BusinessUnitAndAllDescendants B on b.childbusinessunitid=Inv.BusinessUnitId
inner join 
...
--FROM [dbo].[fn_GetRollupBusinessUnitsWithSecurity] (''14887'', ''|'',-1,0)) ba
FROM [dbo].[fn_GetRollupBusinessUnitsWithSecurity] (''^ParamOne^'', ''|'',-1,0)) ba
on ba.RollupBusinessUnitId=b.BusinessUnitId
...
Where 
--i.matterid=''4483621'' and 
i.matterid=^ParamTwo^ and
