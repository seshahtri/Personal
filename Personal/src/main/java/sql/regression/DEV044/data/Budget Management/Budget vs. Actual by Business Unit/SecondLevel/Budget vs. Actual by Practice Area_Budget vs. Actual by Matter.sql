...
end as [Percent of Budget Remaining],[Budget Remaining] from(
...
JOIN (SELECT RollupBusinessUnitId, RollupBusinessUnitName, RollupBusinessUnitPath, RollupBusinessUnitDisplayPath, RollupBusinessUnitLevel
  FROM fn_GetRollupBusinessUnitsWithSecurity (''^ParamOne^'', ''|'',-1,0)) BUS 
  --FROM fn_GetRollupBusinessUnitsWithSecurity (''14883'', ''|'',-1,0)) BUS 
