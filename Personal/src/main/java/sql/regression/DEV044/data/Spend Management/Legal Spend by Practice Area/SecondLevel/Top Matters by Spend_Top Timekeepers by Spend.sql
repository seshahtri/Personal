...
FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (''-1'', ''|'',^ParamOne^,0)) PAS ON PAD.PracticeAreaID = PAS.RollupPracticeAreaId
--FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (''-1'', ''|'',32475,0)) PAS ON PAD.PracticeAreaID = PAS.RollupPracticeAreaId
