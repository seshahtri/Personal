...
FROM [dbo].[fn_GetPracticeAreasWithChildrenWithRollupPracticeArea] (''-1'', ''|'',^ParamOne^)) pa on pa.RollupPracticeAreaId=m.PracticeAreaId
--FROM [dbo].[fn_GetPracticeAreasWithChildrenWithRollupPracticeArea] (''-1'', ''|'',32475)) pa on pa.RollupPracticeAreaId=m.PracticeAreaId

Where m.MatterID = ^ParamTwo^
--m.MatterID = ''3686999''
