...
--SET @pDateStart='112017';
--SET @pDateEnd='12312017';
...
--FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (''32504'', '''',32475,1)
FROM [dbo].[fn_GetRollupPracticeAreasWithSecurity2] (''^ParamTwo^'', '''',^ParamOne^,1)
