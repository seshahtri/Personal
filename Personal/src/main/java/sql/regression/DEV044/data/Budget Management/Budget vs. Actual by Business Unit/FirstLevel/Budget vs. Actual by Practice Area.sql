...
case when [Spend] is null then 100 else [Percent of Budget Remaining] end as [Percent of Budget Remaining],
case when [Spend] is null then [Budget Amount] else [Budget Remaining] end as [Budget Remaining]
from (SELECT [RollupPracticeAreasWithSecurity].[RollupPracticeAreaName] AS [Practice Area],
...
GROUP BY [RollupPracticeAreasWithSecurity].[RollupPracticeAreaName] ) tab
